...
If you want to report a security vulnerability, [create an issue on GitHub](https://github.com/DasIstTobias/randombytes-mc-control/issues/new) and use the ‘Security’ label to mark the issue as a report.
